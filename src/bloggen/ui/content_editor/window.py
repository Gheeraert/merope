...
class ContentEditorWindow(
    ...
    def _configure_tags(self) -> None:
        ...
        text.tag_configure("bullet_marker", font=("TkDefaultFont", 15, "bold"))
        text.tag_configure("table_source", font=("Courier New", 10), background="#f5f5f5", wrap="char")
        text.tag_configure("verbatim", font=("Courier New", 10), background="#fff3cd", wrap="char")
